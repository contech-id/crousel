    ...
    <section id="contact" className="border-t border-border bg-muted/40 px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      <div className="mx-auto grid max-w-[90rem] gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="space-y-4">
          ...
          <a href="https://www.google.com/maps/place/Jl.+Nurpa'i+No.113b,+Citeureup,+Kec.+Cimahi+Utara,+Kota+Cimahi,+Jawa+Barat+40512" target="_blank" rel="noreferrer" className="flex items-center gap-4 rounded-2xl border border-border bg-card p-4 text-sm transition-colors hover:bg-muted" data-aos="fade-left" data-aos-delay="500"><span className="rounded-xl bg-secondary p-3"><MapPin aria-hidden="true" className="size-5" /></span><span className="min-w-0 flex-1"><strong className="block">Lokasi toko</strong><span className="block truncate text-sm text-muted-foreground">Jl. Nurpa'i No.113b, Citeureup, Cimahi Utara</span></span><ExternalLink aria-hidden="true" className="size-4 shrink-0 text-muted-foreground" /></a>
